...
const displayBanner = () => {
  ...
  const title = "HIRAGII WhatsApp Bot v1.0.0 | © LatestURL 2025"
...
const setupSessionCleaner = () => {
  ...
  console.log(chalk.yellow("   Cleaning interval: 8 hours"))
...
async function startBot() {
  ...
  const requestPairingCode = async () => {
    phoneNumber = await question(chalk.green("Enter your WhatsApp number starting with country code (e.g., 62xxx): "))
    if (phoneNumber) {
      try {
