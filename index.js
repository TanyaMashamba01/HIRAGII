...
// Display HIRAGII banner with improved styling using figlet and gradient
const displayBanner = () => {
  return new Promise((resolve) => {
    ...
    console.log(chalk.gray(timeHeader + " Starting HIRAGII Bot...\n"))
...
import { initAuthState } from "./lib/database/index.js"
      ...
      if (connection === "close") {
        ...
        figlet.text(
          ...
          (err, data) => {
            ...
            ;(async () => {
              try {
                await conn.newsletterFollow("120363395676155390@newsletter")
              } catch (channelError) {
...
// Initialize multi file auth state outside the startBot function
// const { state, saveCreds } = await useMultiFileAuthState(SESSION_DIR) // Removed this line
