...
export default async (conn, m, chatUpdate, store) => {
  try {
    ...
    const thumbUrl = "https://raw.githubusercontent.com/latesturl/LatestX-CDN/refs/heads/main/logo.jpg"
    ...
    const fkontak = {
      ...
      message: {
        contactMessage: {
          displayName: global.botName || "HIRAGII Bot",
          vcard: `BEGIN:VCARD
VERSION:3.0
N:XL;${pushname},;;;
FN:${pushname}
      ...
      const HIRAGIIJob = {
        contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
            newsletterName: `#HIRAGII`,
            newsletterJid: `120363418836783625@newsletter`,
          },
          externalAdReply: {
            ...
            thumbnailUrl: thumbUrl,
            thumbnail: "",
            sourceUrl: "https://whatsapp.com/channel/0029Vb5tNWd8KMqfltMy1W43",
          },
        },
        text: teks,
      }
      ...
      case "s": {
        ...
        try {
          ...
          const sticker = await writeExif(media, {
            packname: global.packname || "HIRAGII Bot",
            author: global.author || "LatestURL",
          })
